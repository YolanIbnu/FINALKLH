...
export function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // INFO: Log username tidak apa-apa (opsional), tapi jangan log password
      ...
      if (authData.user && !authError) {
        // HAPUS baris log ini jika tidak ingin ID user terlihat
        ...
        // ❌ HAPUS: Ini membocorkan data profile
        ...
        const userFromAuth = {
          ...
          // Tapi jika sistem Anda memerlukannya, biarkan di sini, ASALKAN JANGAN DI-CONSOLE.LOG
          password: credentials.password,
        }

        // ✅ PERBAIKAN UTAMA: Hapus console.log di bawah ini!
